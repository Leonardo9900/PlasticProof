        ...
        SilentlyAuthenticate(
            (LoginResult result) =>
            {
                ...
                PlayFabClientAPI.UpdatePlayerStatistics(new UpdatePlayerStatisticsRequest
                {
                    ...
                    new StatisticUpdate { StatisticName = "Verified", Value = 1 },
                    }
                },
                result1 => { UnityEngine.Debug.Log("The email is not verified"); },
                ...
                PlayFabClientAPI.UpdateUserTitleDisplayName(
                         ...
                         }, UpdateResult =>
                         {
                             ...
                             PlayerPrefs.SetString("TitleDisplayName", ScoreName);
                         }, UpdateError =>
                         {
                             if (OnPlayFabError != null)
                             {
                                 //Report error result back to subscriber
                                 OnPlayFabError.Invoke(UpdateError);
                             }
                         });
            });
